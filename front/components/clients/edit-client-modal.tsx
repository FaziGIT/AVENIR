...
import { X, Edit, Mail, User } from 'lucide-react';
...
export const EditClientModal = ({
  ...
  const [errors, setErrors] = useState<Partial<Record<keyof EditClientData, string>>>({});
  ...
  const validateForm = (): boolean => {
    const newErrors: Partial<Record<keyof EditClientData, string>> = {};
            ...
            >
              ...
              <form onSubmit={handleSubmit} className="p-6 space-y-4">
                ...
                <div className="flex gap-3 pt-4">
                  ...
                  >
                    {isLoading ? t('common.loading') : t('director.editClient.submit')}
                  </button>
                </div>
              </form>
            </motion.div>
